...
#os.chdir(os.path.dirname(__file__)) # busca el directorio del script para asegurarse que se encuentra en la misma carpeta que el dataset
...
# Reentrena el modelo entrenado con todo el dataset
model.fit(data.drop(columns = ["sales"]), data["sales"])

# Guardar el modelo entrenado con un pickle
